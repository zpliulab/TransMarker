...
base_dir = "/home/fatemeh/ThirdObject/0.RealData/ESCC/cellIDs_by_stage/Filtered_Cleaned_Inputs"
cell = 'CD8'
stages = ['N', 'HGIN', 'INF', 'Stage_I', 'Stage_II', 'Stage_III']  # 'N', 'HGIN', 'INF', 'Stage_I', 'Stage_II', 'Stage_III'
...
for stage in stages:
    exp_path = os.path.join(base_dir, f"fea_{stage}_cleaned_Filtered.csv")
