...
GN = 'G30'  # Graph name (example)
ST = '4'    # State (example)
adj_matrix = np.loadtxt(f'./Input/adj_matrix_{GN}_{ST}.txt').astype(int)  # Ensure integer values
...
file_path_export = os.path.join(output_dir, 'StructuralEncoding_Stage' + ST + '_' + GN + '.txt')
