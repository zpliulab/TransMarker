...
cell = 'CD4'  # Graph name (example) CD4, CD8
...
path="/home/fatemeh/ThirdObject/0.RealData/Filtered_Cleaned_Inputs"
...
gat_model = GAT(in_dim, hidden_channels=128, out_channels=64, dropout=0.6)
...
def train(model, data, epochs=200, patience=50): #epochs=200, patience=10  epochs=2000, patience=50
