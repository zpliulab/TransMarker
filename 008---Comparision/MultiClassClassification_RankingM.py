...
GN = 'CD8'
RankingM='betweenness'
'''
'betweenness', 'bottleneck', 'degree', 'diffusion', 'latora', 'lin',
       'laplacian', 'local', 'leaderrank', 'leverage', 'residual', 'radiality',
       'pagerank'
'''
...
out_path = f'{path}/centrality_combined_rankings_{GN}.csv'
...
with open('./evaluation_results_Reg_ExpFea_'+RankingM+'.txt', "w") as f:
...
roc_data.to_csv('./roc_curve_data_Reg_ExpFea'+RankingM+'.csv', index=False)
...
plt.savefig('ROC_plot_ExpFea_'+RankingM+'.pdf')  # Save as PDF
# Show the plot
plt.show()
